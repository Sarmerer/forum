...
// Writer is a wrapper around http.Writer that provides extra information about
...
func NewResponseWriter(rw http.ResponseWriter) Writer {
	nrw := &responseWriter{
		ResponseWriter: rw,
	}
...
func (rw *responseWriter) Before(before func(Writer)) {
