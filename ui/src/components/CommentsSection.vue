<template>
  <b-skeleton-wrapper :loading="loading">
    ...
    <div :class="isMobile() ? 'card-m' : 'card'">
      <!-- Comment form-start -->
      <b-form v-if="authenticated && !loading" @submit.prevent="addComment">
            ...
            <b-row>
              ...
              <b-col>
                ...
                <b-row align-h="between">
                  <b-col cols="start">
                    <small>
                      <span v-if="!isMobile()" v-b-tooltip.hover title="Rating">
                        <b-icon
                          :icon="`arrow-${comment.rating >= 0 ? 'up' : 'down'}`"
                        ></b-icon>
                        {{ comment.rating }}
                      </span>
                    </small>
                    <small class="mt-1" @click="reply(comment.id)">
                      <u>reply</u>
                    </small>
                  </b-col>
